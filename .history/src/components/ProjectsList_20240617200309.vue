        ...
        <v-card-text>
            <v-tabs-window v-model="selectedTab">
                <v-tabs-window-item
                    ...
                    :key="item.text"
                >
                    <v-card class="mx-auto" prepend-icon="$" width="100%">
                        ...
                        <v-card-text class="bg-surface-light pt-4">
                            ...
                            elit. Commodi, ratione debitis quis est labore
                            voluptatibus! Eaque cupiditate minima, at placeat
                            totam, magni doloremque veniam neque porro libero
