...
const f5 = () => {
    z5 = a5.filter(elem => elem.includes(5));
    console.log(z5);
}
...
let a6 = [
    ...
    [47, 3, 54, 62],
    [5]
]; // ожидаю [[6,7,3], [47, 3, 54, 62]]
let z6 = [];

const f6 = () => {
    z6 = a6.filter(elem => {
        let a = elem.reduce(function (sum, current) {
            return sum + current;
        }, 0);
...
const f7 = () => {
    z7 = a7.filter(elem => elem.pass.length <= 6);
    console.log(z7);
}
