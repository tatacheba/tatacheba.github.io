...
let resultA = 12 * 12;
document.getElementById('two').innerHTML = resultA;
...
// h3.innerHTML = "Произвольный текст";
// document.querySelector('.three').append(h3);
...
four.innerHTML = '<h3>Произвольный текст 1</h3>';
four.innerHTML += '<p>Произвольный текст 2</p>';
