...
function f5() {
   ...
   out.innerHTML = inp < 0 ? 'm' : (inp > 0 ? 1 : 0);
...
function f6() {
   ...
   out.innerHTML = (inp % 2 == 0) ? 'even' : 'odd';
}
...
function f8() {
   let s = +document.querySelector('.s-8').value,
...
function f9() {
   let s = +document.querySelector('.i-9').value,
...
function f10() {
   let s = document.querySelector('.s-100');
...
function f11() {
   let s = document.querySelector('.s-110');
