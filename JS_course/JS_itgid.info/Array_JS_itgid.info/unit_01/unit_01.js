...
const f1 = () => {
    ...
    out.innerHTML = a1.indexOf(inp) == -1 ? 'no' : 'yes';
...
const f2 = () => {
    ...
    if (a1.indexOf(inp) == -1) {
        out.innerHTML = false;
    } else out.innerHTML = a1.indexOf(inp);
...
const f5 = () => {
    let inp5_1 = +document.querySelector('.i-5-1').value;
    let inp5_2 = +document.querySelector('.i-5-2').value;

    function index(arr, elemValue, elemIndex) {
        console.log(elemValue);
        console.log(elemIndex);
        return arr.indexOf(elemValue, elemIndex);
    };
    document.querySelector('.out-5').innerHTML = index(a5, inp5_1, inp5_2);
}
...
const f6 = () => {
    ...
    function index(arr, elemValue) {
        return arr.indexOf(elemValue);
    };
    document.querySelector('.out-6').innerHTML = index(a6, inp6);
}
...
const f8 = () => {
    ...
    let indx = a8.indexOf(inp);
    while (indx != -1) {
        res08.push(indx);
        indx = a8.indexOf(inp, indx + 1)
    }
...
const f9 = () => {
    ...
    for (let i = 0; i < a9.length; i++) {
        let indx = a9[i].indexOf(inp);
        while (indx != -1) {
            res09.push(indx);
            indx = a9[i].indexOf(inp, indx + 1)
        }
    }
