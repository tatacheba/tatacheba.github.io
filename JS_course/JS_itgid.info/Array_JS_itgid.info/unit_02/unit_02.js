...
const f2 = () => {
    ...
    if (a2.includes(inp)) {
        console.log(inp);
        out.innerHTML = a2.indexOf(inp);
    } else {
        out.innerHTML = a2.includes(inp);
    }
...
const f3 = () => {
    ...
    console.log(inp);
    let inpSearch = (array, inp) => {
        for (let i = 0; i < array.length; i++) {
            console.log(array[i]);
            console.log(array[i].includes(inp));
            if (array[i].includes(inp) === true) {
                return true;
            }
        };
        return false;
    ...
    out.innerHTML = inpSearch(a3, inp);
}
