...
const f6 = () => {
    ...
    if (ind == -1) {
        ...
        indLast = (a6.length - 1) - ind;
    }

    document.querySelector('.out-6').innerHTML = indLast;
}
...
const f7 = () => {
    indLast = str7.lastIndexOf(a7_1);
    document.querySelector('.out-7').innerHTML = indLast;
}
...
const f8 = () => {
    indLast = str8.toLowerCase().lastIndexOf(a8_1.toLowerCase());
    document.querySelector('.out-8').innerHTML = indLast;
}
