...
const f1 = () => {
    ...
    document.querySelector('.out-1').innerHTML = a1.indexOf(inp);
...
const f2 = () => {
    ...
    document.querySelector('.out-2').innerHTML = a2.indexOf(inp) > -1 ? a2.indexOf(inp) : false;
}
...
const f3 = () => {
    ...
    document.querySelector('.out-3').innerHTML = a3.indexOf(inp) > -1 ? 'true' : false;
}
...
const f5 = () => {
    ...
    document.querySelector('.out-5').innerHTML = a5.indexOf(inp1, inp2);
}
...
const f6 = () => {
    ...
    document.querySelector('.out-6').innerHTML = a6.indexOf(inp);
}
