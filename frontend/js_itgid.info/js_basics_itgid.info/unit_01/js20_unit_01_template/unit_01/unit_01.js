...
let out17 = document.querySelector('.out-17').textContent;
console.log(out17);
console.dir(out17);
...
let out18 = document.querySelector('.out-18').textContent;
console.log(out18);
out18 = 5;
console.log(out18);
...
console.log(out19);
out19 = document.querySelector('.out-19-test').textContent;
console.log(out19);
