...
function t8() {
    outDataTask8.textContent = inputDataTask8.value;
...
function t9() {
    outDataTask9.textContent = inputDataTask9.value;
...
function t10() {
    outDataTask10.textContent = inputDataTask10.value * 20;
}
...
function t11() {
    outDataTask11.textContent = inputDataTask11.value + 55;
}
...
let inputDataTask12_1 = document.querySelector('.i-12-1'),
    inputDataTask12_2 = document.querySelector('.i-12-2'),
...
let inputDataTask13_1 = document.querySelector('.i-13-1'),
    inputDataTask13_2 = document.querySelector('.i-13-2'),
...
function t19() {
    document.querySelector(".out-19").textContent = +document.querySelector(".i-19-1").value + +document.querySelector(".i-19-2").value;
}
