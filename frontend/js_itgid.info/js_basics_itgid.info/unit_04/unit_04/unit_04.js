...
function f4() {
    let out = document.querySelector('.out-4'),
        inp = document.querySelector('.i-4');
    out.innerHTML = inp.checked ? true : false;
}
...
function f5() {
    let out = document.querySelector('.out-5'),
        inp = document.querySelector('.i-5');
    out.innerHTML = inp.checked ? inp.value : false;
}
...
function f6() {
    let out = document.querySelector('.out-6'),
        inp = document.querySelector('.i-6');
...
function f7() {
    ...
    out2.innerHTML = (inp.value.length >= 6) ? 1 : 0;
}
...
function f9() {
    let out = document.querySelector('.out-9'),
        radio = document.querySelector('.r-9');
    out.innerHTML = radio.checked ? radio.value : false;
}
...
function f11() {
    let inp1 = document.querySelector('.i-111'),
        inp2 = document.querySelector('.i-112');
...
function f15() {
    let inp = document.querySelector('.i-15'),
        text = document.querySelector('.t-15'),
...
function f18() {
    let sel = document.querySelector('.s-18'),
        inp = document.querySelector('.i-18');
    inp.value = sel.value;
}
...
function f20() {
    let sel1 = document.querySelector('.s-201'),
        sel2 = document.querySelector('.s-202');
    sel2.options.selectedIndex = sel1.options.selectedIndex;
}
