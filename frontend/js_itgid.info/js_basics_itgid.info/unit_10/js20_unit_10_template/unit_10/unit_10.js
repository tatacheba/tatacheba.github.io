...
let ar3 = ['asa', true, 1, 'f35', 43, 'as'];

function f3() {
    let out = document.querySelector('.out-3');
    out.innerHTML = "Массив: " + ar3 + " " + "Длина: " + ar3.length;
}
...
let ar4 = [5, 78, 1, 36, 43, 76, 2424, 7, 54, 5];
...
// let ar5 =
let ar5 = [5, 78, 1, 36, 43, 76, 2424, 7, 54, 5];
...
function f10() {
    ...
    out.innerHTML = ar10[0] + ar10[ar10.length - 1];
}
...
function f16() {
    ...
    for (let k = 0; k < ar16.length; k++) {
        if (ar16[k] % 2 == 0) {
            ar16_even.push(ar16[k]);
            outEven += ar16[k] + " ";
        } else {
            ar16_odd.push(ar16[k]);
            outOdd += ar16[k] + " ";
        }
...
function f19() {
    let min = ar19[0],
        minInd = 0;
    for (let k = 0; k < ar19.length; k++) {
        if (ar19[k] < min) {
            min = ar19[k];
            minInd = k;
        }
    }
    document.querySelector('.out-19').innerHTML = minInd;
}
