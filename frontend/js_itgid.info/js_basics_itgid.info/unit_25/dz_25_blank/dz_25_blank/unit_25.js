...
function t2() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Tatiana", true);
    xhttp.send();
...
function t3() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=2&num2=3", true);
    xhttp.send();
...
function t4() {
    ...
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=2&num2=30", true);
    xhttp.send();
}
...
function t8() {
    let xhttp = new XMLHttpRequest();
    xhttp.open("GET", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1990", true);
    xhttp.send();
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t11() {
    let xhttp = new XMLHttpRequest();
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Tatiana", true);
    xhttp.send();
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t12() {
    let xhttp = new XMLHttpRequest();
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=2&num2=8", true);
    xhttp.send();
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t13() {
    let xhttp = new XMLHttpRequest();
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=2&num2=8", true);
    xhttp.send();
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t15() {
    let xhttp = new XMLHttpRequest();
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=3&num2=7", true);
    xhttp.send();
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
...
function t17() {
    let xhttp = new XMLHttpRequest();
    xhttp.open("POST", "http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1990", true);
    xhttp.send();
    xhttp.onreadystatechange = function () {
        if (this.readyState == 4 && this.status == 200) {
