...
function t2() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=2&name=Tatiana')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t3() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=3&num1=4&num2=9')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t4() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=4&num1=4&num2=9')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t6() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=6&num1=4&num2=9')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t8() {
    fetch('http://getpost.itgid.info/index2.php?auth=DdC33D7d2C2a7&action=8&year=1990')
        .then(data => {
            return data.text();
        })
        .then(data => {
...
function t11() {
    fetch("http://getpost.itgid.info/index2.php", {
            ...
            body: 'auth=DdC33D7d2C2a7&action=2&name=Tatiana'
        })
        .then(response => response.text())
        .then(response => {
...
function t12() {
    fetch("http://getpost.itgid.info/index2.php", {
            ...
            body: 'auth=DdC33D7d2C2a7&action=3&num1=2&num2=9'
        })
        .then(response => response.text())
        .then(response => {
...
function t13() {
    fetch("http://getpost.itgid.info/index2.php", {
            ...
            body: 'auth=DdC33D7d2C2a7&action=4&num1=2&num2=9'
        })
        .then(response => response.text())
        .then(response => {
...
function t15() {
    fetch("http://getpost.itgid.info/index2.php", {
            ...
            body: 'auth=DdC33D7d2C2a7&action=6&num1=2&num2=9'
        })
        .then(response => response.text())
        .then(response => {
...
function t17() {
    fetch("http://getpost.itgid.info/index2.php", {
            ...
            body: 'auth=DdC33D7d2C2a7&action=8&year=1990'
        })
        .then(response => response.text())
        .then(response => {
