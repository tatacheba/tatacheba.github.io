 ...
 let goods2 = new Goods('name', 5, '1.png', 5, "out-4", 4);
 goods2.draw();
 ...
 let goods3 = new Goods2('name', 5, '4.png', 95, "out-6", 4, true);
 goods3.draw();
 ...
 let val1 = new Valid('email', 'jjcfm', false);
 val1.validate();
 ...
 let val2 = new Valid('email', 'jj44cfm', false);
 val2.validate();
 ...
 let valid3 = new Valid2('email', '123456789', false)
 valid3.validate();
 console.log(valid3)