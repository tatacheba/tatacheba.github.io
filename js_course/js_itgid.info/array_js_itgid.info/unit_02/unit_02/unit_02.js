...
const f1 = () => {
    ...
    document.querySelector('.out-1').innerHTML = a1.includes(inp);
...
const f2 = () => {
    ...
    document.querySelector('.out-2').innerHTML = a2.includes(inp) ? a2.indexOf(inp) : false;
}
...
const f4 = () => {
    ...
    let count = 0;
    for (let key in a4) {
        if (a4[key].includes(inp) == true) {
            out += key + ' ';
        } else {
            count++;
        }
        if (count == Object.keys(a4).length) {
            out = false;
        }
...
const f5 = () => {
    let inp1 = +document.querySelector('.i-5-1').value;
    let inp2 = +document.querySelector('.i-5-2').value;

    document.querySelector('.out-5').innerHTML = a5.includes(inp1, inp2);
}
...
const f6 = () => {
    ...
    document.querySelector('.out-6').innerHTML = a6.includes(inp);
...
const f8 = () => {
    ...
    document.querySelector('.out-8').innerHTML = a8.includes(inp);
...
const f9 = () => {
    ...
    a9.forEach(elem => {
        if (isNaN(elem) == false) {
            ...
            a9Str.push(elem.toLowerCase());
        }
    })
    out = (isNaN(inp) == false) ? a9Num.includes(+inp) : a9Str.includes(inp.toLowerCase());
