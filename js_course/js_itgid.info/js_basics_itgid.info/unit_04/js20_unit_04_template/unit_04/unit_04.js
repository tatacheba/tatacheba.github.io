...
function f4() {
    document.querySelector('.out-4').innerHTML = document.querySelector('.i-4').checked ? true : false;
}
...
function f5() {
    ...
    document.querySelector('.out-5').innerHTML = inp.checked ? inp.value : false;
}
...
function f7() {
    ...
    document.querySelector('.out-71').innerHTML = inp.value;
    document.querySelector('.out-72').innerHTML = (inp.value.length >= 6) ? 1 : 0;
}
...
function f9() {
    ...
    document.querySelector('.out-9').innerHTML = radio.checked ? radio.value : false;
}
...
function f10() {
    ...
    document.querySelector('.out-10').style.backgroundColor = inp.value;
}
...
function f11() {
    document.querySelector('.i-111').value = document.querySelector('.i-112').value;
}
...
function f15() {
    ...
    document.querySelector('.t-15').value = inp.value;
...
function f20() {
    document.querySelector('.s-202').options.selectedIndex = document.querySelector('.s-201').options.selectedIndex;
}
