...
const f4 = () => {
    document.querySelector('.out-4').innerHTML = s4.has(document.querySelector('.i-4').value);
}
...
const f6 = () => {
    ...
    document.querySelector('.out-6').innerHTML = a6Set.size;
}
...
const f7 = () => {
    ...
    let inpSet = new Set(inp);
    document.querySelector('.out-7').innerHTML = (inpSet.size > 6) ? 1 : 0;
}
...
const f10 = (out_set, elem) => {
    document.querySelector(elem).innerHTML = [...out_set].join(" ");
}
...
const f13 = () => {
    let str13Set = new Set(str13);
    let str13Arr = Array.from(str13);
    let str13NewArr = {};
    for (let item of str13Set) {
        let k = 0;
        for (j = 0; j < str13Arr.length; j++) {
            if (item === str13Arr[j]) {
                k++;
            };
        }
