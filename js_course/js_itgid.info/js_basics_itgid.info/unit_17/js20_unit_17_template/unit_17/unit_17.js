...
function t6() {
    a6_res = a6.filter(element => {
        if (typeof element == 'number' && element > 14) {
            return element;
        }
    })
    return a6_res;
...
function t8() {
    a8_res = a8.map((e, i) => e % 2 == 0 ? i : undefined).filter(e => e)
    return a8_res;
}
...
function t9() {
    let a = [];
    a9.forEach(e => a.push(e.toLowerCase()));
    a9 = a;
    return a9;
}
...
function t15() {
    a15_res = a15.filter(e => e.pnum.length == 6);
    return a15_res;
