...
<!-- Mirrored from mustard-ui.com/docs/alerts/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:12:11 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Alerts &middot; Simple CSS Styles for Alerts &middot; Mustard UI</title>

<meta name="description" content="Alerts can be used to place emphasis on a dialog or message that a visitor needs to see. Currently there are 4 different styles that can be used. Pick a style that relates most to your intended message."/>
<link rel="canonical" href="index.html" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Alerts &middot; Simple CSS Styles for Alerts &middot; Mustard UI" />
<meta property="og:description" content="Alerts can be used to place emphasis on a dialog or message that a visitor needs to see. Currently there are 4 different styles that can be used. Pick a style that relates most to your intended message." />
...
<meta name="twitter:description" content="Alerts can be used to place emphasis on a dialog or message that a visitor needs to see. Currently there are 4 different styles that can be used. Pick a style that relates most to your intended message." />
<meta name="twitter:title" content="Alerts &middot; Simple CSS Styles for Alerts &middot; Mustard UI" />
...
<script type='application/ld+json' class='yoast-schema-graph yoast-schema-graph--main'>{"@context":"https://schema.org","@graph":[{"@type":"WebSite","@id":"https://mustard-ui.com/#website","url":"https://mustard-ui.com/","name":"Mustard UI","potentialAction":{"@type":"SearchAction","target":"https://mustard-ui.com/?s={search_term_string}","query-input":"required name=search_term_string"}},{"@type":"WebPage","@id":"https://mustard-ui.com/docs/alerts/#webpage","url":"https://mustard-ui.com/docs/alerts/","inLanguage":"en-US","name":"Alerts &middot; Simple CSS Styles for Alerts &middot; Mustard UI","isPartOf":{"@id":"https://mustard-ui.com/#website"},"datePublished":"2018-04-02T01:13:17+00:00","dateModified":"2018-04-08T23:06:00+00:00","description":"Alerts can be used to place emphasis on a dialog or message that a visitor needs to see. Currently there are 4 different styles that can be used. Pick a style that relates most to your intended message."}]}</script>
...
<link rel="alternate" type="application/json+oembed" href="../../wp-json/oembed/1.0/embed5ef6.json?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Falerts%2F" />
<link rel="alternate" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embedf9b4?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Falerts%2F&amp;format=xml" />
    ...
    <div class="form-control col col-md-6 display-lg-down">
        ...
        <select onchange="window.location.href=this.value">
                            ...
                            <optgroup label="Components">
                                            ...
                                            <option value="https://mustard-ui.com/docs/alerts/" selected>Alerts</option>
                            ...
                            <p>Alerts can be used to place emphasis on a dialog or message that a visitor needs to see.  Currently there are 4 different styles that can be used.  Pick a style that relates most to your intended message.</p>

<p>If you&#8217;d like to present a more interruptive dialog that requires user action, take a look at <a href="../modals/index.html">modals</a>.</p>

<p class='codepen'  data-height='645' data-theme-id='0' data-slug-hash='xWmOpe' data-default-tab='result' data-animations='run' data-editable='true' data-embed-version='2'>
See the Pen <a href='https://codepen.io/kylelogue/pen/xWmOpe/'>Alert Styles</a> by Kyle Logue (<a href='https://codepen.io/kylelogue'>@kylelogue</a>) on <a href='https://codepen.io/'>CodePen</a>.0</p>
<script async src="https://static.codepen.io/assets/embed/ei.js"></script>                        </section>
                        <section class="align-right">
                            Up Next: <a href="../breadcrumbs/index.html" rel="next">Breadcrumbs</a> &raquo;                        </section>
                    </div>
...
<div class="sidebar sidebar-left">
        ...
        <ul class="sidebar-links">
                            <li><a class="active" href="index.html">Alerts</a></li>
...
<!-- Mirrored from mustard-ui.com/docs/alerts/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:12:14 GMT -->
</html>
