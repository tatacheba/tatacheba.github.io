...
<!-- Mirrored from mustard-ui.com/docs/breakpoint-mixin/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:12:58 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>CSS Breakpoints &middot; SCSS Breakpoint Mixin &middot; Mustard UI</title>

<meta name="description" content="This mixin provides a quick way to apply certain styles to elements at certain breakpoints. Breakpoints can also be defined within the breakpoint variables."/>
<link rel="canonical" href="index.html" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="CSS Breakpoints &middot; SCSS Breakpoint Mixin &middot; Mustard UI" />
<meta property="og:description" content="This mixin provides a quick way to apply certain styles to elements at certain breakpoints. Breakpoints can also be defined within the breakpoint variables." />
...
<meta name="twitter:description" content="This mixin provides a quick way to apply certain styles to elements at certain breakpoints. Breakpoints can also be defined within the breakpoint variables." />
<meta name="twitter:title" content="CSS Breakpoints &middot; SCSS Breakpoint Mixin &middot; Mustard UI" />
...
<link rel="alternate" type="application/json+oembed" href="../../wp-json/oembed/1.0/embed4ab8.json?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Fbreakpoint-mixin%2F" />
<link rel="alternate" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embed972b?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Fbreakpoint-mixin%2F&amp;format=xml" />
    ...
    <div class="form-control col col-md-6 display-lg-down">
        ...
        <select onchange="window.location.href=this.value">
                            ...
                            <optgroup label="Mixins">
                                            ...
                                            <option value="https://mustard-ui.com/docs/breakpoint-mixin/" selected>Breakpoint Mixin</option>
                            ...
                            <h1 class="h2">Breakpoint Mixin</h1>
                            <p>This mixin provides a quick way to apply certain styles to elements at certain breakpoints.  Breakpoints can also be defined within the <a href="../variables/index.html">breakpoint variables</a>.  Like other mixins, usage will require that you install mustard via <code class="language-bash">npm</code> and include the source within your main SCSS file.</p>
            ...
            @media (min-width: $bp1) and (max-width: $bp2) {
                @content;
                        ...
                        <section class="align-right">
                            Up Next: <a href="../centering-mixins/index.html" rel="next">Centering Mixins</a> &raquo;                        </section>
                    </div>
...
<div class="sidebar sidebar-left">
        ...
        <ul class="sidebar-links">
                            <li><a class="active" href="index.html">Breakpoint Mixin</a></li>
...
<!-- Mirrored from mustard-ui.com/docs/breakpoint-mixin/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:13:01 GMT -->
</html>
