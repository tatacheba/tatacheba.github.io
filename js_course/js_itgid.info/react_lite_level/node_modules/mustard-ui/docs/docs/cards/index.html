...
<!-- Mirrored from mustard-ui.com/docs/cards/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:12:03 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Cards &middot; Simple CSS Styles for Cards &middot; Mustard UI</title>

<meta name="description" content="Cards can be used for repeating elements that need to stack on smaller screen sizes. By combining both the flexbox grid and cards, you can create structure to place things like blog entries, customer reviews, or prominent features."/>
<link rel="canonical" href="index.html" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Cards &middot; Simple CSS Styles for Cards &middot; Mustard UI" />
<meta property="og:description" content="Cards can be used for repeating elements that need to stack on smaller screen sizes. By combining both the flexbox grid and cards, you can create structure to place things like blog entries, customer reviews, or prominent features." />
...
<meta name="twitter:description" content="Cards can be used for repeating elements that need to stack on smaller screen sizes. By combining both the flexbox grid and cards, you can create structure to place things like blog entries, customer reviews, or prominent features." />
<meta name="twitter:title" content="Cards &middot; Simple CSS Styles for Cards &middot; Mustard UI" />
...
<script type='application/ld+json' class='yoast-schema-graph yoast-schema-graph--main'>{"@context":"https://schema.org","@graph":[{"@type":"WebSite","@id":"https://mustard-ui.com/#website","url":"https://mustard-ui.com/","name":"Mustard UI","potentialAction":{"@type":"SearchAction","target":"https://mustard-ui.com/?s={search_term_string}","query-input":"required name=search_term_string"}},{"@type":"WebPage","@id":"https://mustard-ui.com/docs/cards/#webpage","url":"https://mustard-ui.com/docs/cards/","inLanguage":"en-US","name":"Cards &middot; Simple CSS Styles for Cards &middot; Mustard UI","isPartOf":{"@id":"https://mustard-ui.com/#website"},"datePublished":"2018-04-02T01:13:37+00:00","dateModified":"2018-04-08T23:50:36+00:00","description":"Cards can be used for repeating elements that need to stack on smaller screen sizes. By combining both the flexbox grid and cards, you can create structure to place things like blog entries, customer reviews, or prominent features."}]}</script>
...
<link rel="alternate" type="application/json+oembed" href="../../wp-json/oembed/1.0/embed1651.json?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Fcards%2F" />
<link rel="alternate" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embed8ff0?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Fcards%2F&amp;format=xml" />
    ...
    <div class="form-control col col-md-6 display-lg-down">
        ...
        <select onchange="window.location.href=this.value">
                            ...
                            <optgroup label="Components">
                                            ...
                                            <option value="https://mustard-ui.com/docs/cards/" selected>Cards</option>
                            ...
                            <optgroup label="Utility Classes">
                                            ...
                                            <option value="../alignment/index.html" >Alignment</option>
                            ...
                            <p>Cards can be used for repeating elements that need to stack on smaller screen sizes.  By combining both the <a href="../flexbox-grid/index.html">flexbox grid</a> and cards, you can create structure to place things like blog entries, customer reviews, or prominent features of your product or service.</p>
<p>Cards are closely related to <a href="../panels/index.html">panels</a>, but differ in style and presentation.  Pick the right component for the type of content you want to use.</p>

<p class='codepen'  data-height='531' data-theme-id='0' data-slug-hash='bvOwbL' data-default-tab='result' data-animations='run' data-editable='true' data-embed-version='2'>
See the Pen <a href='https://codepen.io/kylelogue/pen/bvOwbL/'>Card Styles</a> by Kyle Logue (<a href='https://codepen.io/kylelogue'>@kylelogue</a>) on <a href='https://codepen.io/'>CodePen</a>.0</p>
<script async src="https://static.codepen.io/assets/embed/ei.js"></script>                        </section>
                        <section class="align-right">
                            Up Next: <a href="../footer/index.html" rel="next">Footer</a> &raquo;                        </section>
                    </div>
...
<div class="sidebar sidebar-left">
        ...
        <ul class="sidebar-links">
                    ...
                    <h3 class="sidebar-category active">Components</h3>
        ...
        <ul class="sidebar-links">
                            <li><a class="" href="../alignment/index.html">Alignment</a></li>
...
<!-- Mirrored from mustard-ui.com/docs/cards/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:12:05 GMT -->
</html>
