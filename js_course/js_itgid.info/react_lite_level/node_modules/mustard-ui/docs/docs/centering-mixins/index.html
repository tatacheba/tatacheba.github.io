...
<!-- Mirrored from mustard-ui.com/docs/centering-mixins/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:13:01 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>CSS Centering &middot; SCSS Centering Mixin &middot; Mustard UI</title>

<meta name="description" content="Mutliple mixins are provided to center content in different ways using an absolute position. These are used to provide a shortcut for centering elements on the screen."/>
<link rel="canonical" href="index.html" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="CSS Centering &middot; SCSS Centering Mixin &middot; Mustard UI" />
<meta property="og:description" content="Mutliple mixins are provided to center content in different ways using an absolute position. These are used to provide a shortcut for centering elements on the screen." />
...
<meta name="twitter:description" content="Mutliple mixins are provided to center content in different ways using an absolute position. These are used to provide a shortcut for centering elements on the screen." />
<meta name="twitter:title" content="CSS Centering &middot; SCSS Centering Mixin &middot; Mustard UI" />
...
<script type='application/ld+json' class='yoast-schema-graph yoast-schema-graph--main'>{"@context":"https://schema.org","@graph":[{"@type":"WebSite","@id":"https://mustard-ui.com/#website","url":"https://mustard-ui.com/","name":"Mustard UI","potentialAction":{"@type":"SearchAction","target":"https://mustard-ui.com/?s={search_term_string}","query-input":"required name=search_term_string"}},{"@type":"WebPage","@id":"https://mustard-ui.com/docs/centering-mixins/#webpage","url":"https://mustard-ui.com/docs/centering-mixins/","inLanguage":"en-US","name":"CSS Centering &middot; SCSS Centering Mixin &middot; Mustard UI","isPartOf":{"@id":"https://mustard-ui.com/#website"},"datePublished":"2018-04-02T01:29:25+00:00","dateModified":"2018-04-04T14:45:16+00:00","description":"Mutliple mixins are provided to center content in different ways using an absolute position. These are used to provide a shortcut for centering elements on the screen."}]}</script>
...
<link rel="alternate" type="application/json+oembed" href="../../wp-json/oembed/1.0/embed2ba6.json?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Fcentering-mixins%2F" />
<link rel="alternate" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embedfdff?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Fcentering-mixins%2F&amp;format=xml" />
    ...
    <div class="form-control col col-md-6 display-lg-down">
        ...
        <select onchange="window.location.href=this.value">
                            ...
                            <optgroup label="Mixins">
                                            ...
                                            <option value="https://mustard-ui.com/docs/centering-mixins/" selected>Centering Mixins</option>
                            ...
                            <h1 class="h2">Centering Mixins</h1>
                            <p>Mutliple mixins are provided to center content in different ways using an absolute position.  These are used to provide a shortcut for centering elements on the screen.  For other options, see the <a href="../alignment/index.html">alignment classes</a> and the <a href="../flexbox-grid/index.html">flexbox grid</a>.  Like other mixins, usage will require that you install mustard via <code class="language-bash">npm</code> and include the source within your main SCSS file.</p>
        ...
        @mixin center-xy {
            ...
            transform: translate(-50%, -50%);
                        ...
                        <section class="align-right">
                            Up Next: <a href="../clearfix-mixin/index.html" rel="next">Clearfix Mixin</a> &raquo;                        </section>
                    </div>
...
<div class="sidebar sidebar-left">
        ...
        <ul class="sidebar-links">
                    ...
                    <h3 class="sidebar-category active">Mixins</h3>

        
        <ul class="sidebar-links">
                            <li><a class="" href="../breakpoint-mixin/index.html">Breakpoint Mixin</a></li>
                            <li><a class="active" href="index.html">Centering Mixins</a></li>
...
<!-- Mirrored from mustard-ui.com/docs/centering-mixins/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:13:04 GMT -->
</html>
