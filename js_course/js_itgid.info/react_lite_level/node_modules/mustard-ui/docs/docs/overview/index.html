...
<!-- Mirrored from mustard-ui.com/docs/overview/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:12:05 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Why use Mustard UI? &middot; CSS Framework Overview &middot; Mustard UI</title>

<link rel="canonical" href="index.html" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Why use Mustard UI? &middot; CSS Framework Overview &middot; Mustard UI" />
<meta property="og:description" content="Thank you for considering Mustard UI! A complete solution: Mustard UI is a complete CSS framework that is production ready out of the box. There is no need to customize the CSS if you don&#8217;t want to because it is head and shoulders above others in terms of the way that it looks. We think &hellip;" />
...
<meta name="twitter:description" content="Thank you for considering Mustard UI! A complete solution: Mustard UI is a complete CSS framework that is production ready out of the box. There is no need to customize the CSS if you don&#8217;t want to because it is head and shoulders above others in terms of the way that it looks. We think [&hellip;]" />
<meta name="twitter:title" content="Why use Mustard UI? &middot; CSS Framework Overview &middot; Mustard UI" />
...
<link rel="alternate" type="application/json+oembed" href="../../wp-json/oembed/1.0/embed4a95.json?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Foverview%2F" />
<link rel="alternate" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embed089e?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Foverview%2F&amp;format=xml" />
    ...
    <div class="form-control col col-md-6 display-lg-down">
        ...
        <select onchange="window.location.href=this.value">
                            <optgroup label="Getting Started">
                                            ...
                                            <option value="https://mustard-ui.com/docs/overview/" selected>Overview</option>
                            ...
                            <p>Thank you for considering Mustard UI!</p>
<p><strong>A complete solution:</strong> Mustard UI is a complete CSS framework that is production ready out of the box.  There is no need to customize the CSS if you don&#8217;t want to because it is head and shoulders above others in terms of the way that it looks.  We think it looks great and hope you do too.</p>

<p><strong>Minimal CSS:</strong> This entire site was created with an attempt to only use the CSS provided by mustard.  The additions made via custom css were minimal.  That&#8217;s an impressive feat considering that the entire framework comes in at <strong>5kb</strong> when gzipped.</p>

<p><strong>Community driven:</strong> Mustard UI is created as a free open source framework. You are invited to contribute to the source by getting involved on <a href="https://github.com/kylelogue/mustard-ui">GitHub</a>. Really! Do it.</p>
...
<p><strong>Install and Share:</strong></p>
<p>Install or use Mustard UI via the various <a href="../installation/index.html">installation methods</a> and don&#8217;t forget to share what you&#8217;ve created with us.  We&#8217;d love to see what you&#8217;ve made.</p>

<p><a class="button button-primary" href="docs/installation.html">Install Now</a></p>                        </section>
...
<!-- Mirrored from mustard-ui.com/docs/overview/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:12:08 GMT -->
</html>
