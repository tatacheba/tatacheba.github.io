...
<!-- Mirrored from mustard-ui.com/docs/tables/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:12:48 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Tables &middot; Simple CSS Styles for Tables &middot; Mustard UI</title>

<meta name="description" content="Gone are the days of using tables for layout, but tables are still a great way to show data or transactional items. The default styles are gone and we&#039;ve added in some subtle styles that give off a more professional design."/>
<link rel="canonical" href="index.html" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Tables &middot; Simple CSS Styles for Tables &middot; Mustard UI" />
<meta property="og:description" content="Gone are the days of using tables for layout, but tables are still a great way to show data or transactional items. The default styles are gone and we&#039;ve added in some subtle styles that give off a more professional design." />
...
<meta name="twitter:description" content="Gone are the days of using tables for layout, but tables are still a great way to show data or transactional items. The default styles are gone and we&#039;ve added in some subtle styles that give off a more professional design." />
<meta name="twitter:title" content="Tables &middot; Simple CSS Styles for Tables &middot; Mustard UI" />
...
<script type='application/ld+json' class='yoast-schema-graph yoast-schema-graph--main'>{"@context":"https://schema.org","@graph":[{"@type":"WebSite","@id":"https://mustard-ui.com/#website","url":"https://mustard-ui.com/","name":"Mustard UI","potentialAction":{"@type":"SearchAction","target":"https://mustard-ui.com/?s={search_term_string}","query-input":"required name=search_term_string"}},{"@type":"WebPage","@id":"https://mustard-ui.com/docs/tables/#webpage","url":"https://mustard-ui.com/docs/tables/","inLanguage":"en-US","name":"Tables &middot; Simple CSS Styles for Tables &middot; Mustard UI","isPartOf":{"@id":"https://mustard-ui.com/#website"},"datePublished":"2018-04-02T01:26:56+00:00","dateModified":"2018-04-08T14:08:20+00:00","description":"Gone are the days of using tables for layout, but tables are still a great way to show data or transactional items. The default styles are gone and we've added in some subtle styles that give off a more professional design."}]}</script>
...
<link rel="alternate" type="application/json+oembed" href="../../wp-json/oembed/1.0/embed2c27.json?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Ftables%2F" />
<link rel="alternate" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embed38ba?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Ftables%2F&amp;format=xml" />
    ...
    <div class="form-control col col-md-6 display-lg-down">
        ...
        <select onchange="window.location.href=this.value">
                            ...
                            <optgroup label="HTML Elements">
                                            ...
                                            <option value="https://mustard-ui.com/docs/tables/" selected>Tables</option>
                            ...
                            <p>Gone are the days of using tables for layout, but tables are still a great way to show data or transactional items.  The default styles are gone and we&#8217;ve added in some subtle styles that give off a more professional design.  Below you&#8217;ll find an example of a shopping cart that was created using tables.</p>

<p class='codepen'  data-height='625' data-theme-id='0' data-slug-hash='e0e4daaa53ed8ba16ef635a954b29865' data-default-tab='result' data-animations='run' data-editable='true' data-embed-version='2'>
See the Pen <a href='https://codepen.io/kylelogue/pen/e0e4daaa53ed8ba16ef635a954b29865/'>Table Styles</a> by Kyle Logue (<a href='https://codepen.io/kylelogue'>@kylelogue</a>) on <a href='https://codepen.io/'>CodePen</a>.0</p>
<script async src="https://static.codepen.io/assets/embed/ei.js"></script>                        </section>
                        <section class="align-right">
                            Up Next: <a href="../typography/index.html" rel="next">Typography</a> &raquo;                        </section>
                    </div>
...
<div class="sidebar sidebar-left">
        ...
        <ul class="sidebar-links">
                    ...
                    <h3 class="sidebar-category active">HTML Elements</h3>
        ...
        <ul class="sidebar-links">
                            ...
                            <li><a class="active" href="index.html">Tables</a></li>
...
<!-- Mirrored from mustard-ui.com/docs/tables/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:12:50 GMT -->
</html>
