...
<!-- Mirrored from mustard-ui.com/docs/variables/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:12:08 GMT -->
<!-- Added by HTTrack --><meta http-equiv="content-type" content="text/html;charset=UTF-8" /><!-- /Added by HTTrack -->
<head>
    <meta charset="utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Colors and Breakpoints &middot; SCSS Variables &middot; Mustard UI</title>

<meta name="description" content="The variables available define both breakpoints and colors. Currently there are 4 breakpoint variables based on various device sizes that are being targeted. The various colors included are listed in terms of weights instead of shades."/>
<link rel="canonical" href="index.html" />
<meta property="og:locale" content="en_US" />
<meta property="og:type" content="article" />
<meta property="og:title" content="Colors and Breakpoints &middot; SCSS Variables &middot; Mustard UI" />
<meta property="og:description" content="The variables available define both breakpoints and colors. Currently there are 4 breakpoint variables based on various device sizes that are being targeted. The various colors included are listed in terms of weights instead of shades." />
...
<meta name="twitter:description" content="The variables available define both breakpoints and colors. Currently there are 4 breakpoint variables based on various device sizes that are being targeted. The various colors included are listed in terms of weights instead of shades." />
<meta name="twitter:title" content="Colors and Breakpoints &middot; SCSS Variables &middot; Mustard UI" />
...
<script type='application/ld+json' class='yoast-schema-graph yoast-schema-graph--main'>{"@context":"https://schema.org","@graph":[{"@type":"WebSite","@id":"https://mustard-ui.com/#website","url":"https://mustard-ui.com/","name":"Mustard UI","potentialAction":{"@type":"SearchAction","target":"https://mustard-ui.com/?s={search_term_string}","query-input":"required name=search_term_string"}},{"@type":"WebPage","@id":"https://mustard-ui.com/docs/variables/#webpage","url":"https://mustard-ui.com/docs/variables/","inLanguage":"en-US","name":"Colors and Breakpoints &middot; SCSS Variables &middot; Mustard UI","isPartOf":{"@id":"https://mustard-ui.com/#website"},"datePublished":"2018-04-02T00:52:06+00:00","dateModified":"2018-04-04T15:59:21+00:00","description":"The variables available define both breakpoints and colors. Currently there are 4 breakpoint variables based on various device sizes that are being targeted. The various colors included are listed in terms of weights instead of shades."}]}</script>
...
<link rel="alternate" type="application/json+oembed" href="../../wp-json/oembed/1.0/embedd07a.json?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Fvariables%2F" />
<link rel="alternate" type="text/xml+oembed" href="../../wp-json/oembed/1.0/embed605a?url=https%3A%2F%2Fmustard-ui.com%2Fdocs%2Fvariables%2F&amp;format=xml" />
    ...
    <div class="form-control col col-md-6 display-lg-down">
        ...
        <select onchange="window.location.href=this.value">
                            <optgroup label="Getting Started">
                                            ...
                                            <option value="https://mustard-ui.com/docs/variables/" selected>Variables</option>
                            ...
                            <p>The variables available define both <strong>breakpoints</strong> and <strong>colors</strong>.  Currently there are 4 breakpoint variables based on various device sizes that are being targeted.  You can take a look at the <a href="../breakpoint-mixin/index.html">breakpoint mixin</a> to see where you might use them.  The color variables have a new take on what color definitions should look like.</p>
<p>The colors offered are listed in terms of weights instead of shades.  If you think about the number following a color variable in the same way that you would think of a font-weight, then each variable &#8220;weight&#8221; will match that of another color.  It&#8217;s an easy way to determine what colors to use and what colors will go well together.</p>
<p>
<strong>Breakpoint Variables:</strong></p>
    ...
    <code class="language-css">
        ...
        // There are many more colors (20 in all)
                        ...
                        <section class="align-right">
                            Up Next: <a href="../alerts/index.html" rel="next">Alerts</a> &raquo;                        </section>
                    </div>
...
<div class="sidebar sidebar-left">
        ...
        <ul class="sidebar-links">
                            ...
                            <li><a class="active" href="index.html">Variables</a></li>
                    </ul>
...
<!-- Mirrored from mustard-ui.com/docs/variables/ by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 18 Feb 2020 23:12:11 GMT -->
</html>
