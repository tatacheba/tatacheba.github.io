  ...
  <div class="resume-sidebar">
    <router-link to="/">
      <div class="profile-quote">
        <img src="/public/red.jpg" /></div
    ></router-link>
    <div class="contact-info">
      <h2>Contacts</h2>
      <div>
        <img src="/public/location.png" alt="" srcset="" width="20px" height="20px" />
        Podgorica, Montenegro
      </div>
      <div>
        <img src="/public/email.png" alt="" srcset="" width="20px" height="20px" />
        <a href="mailto:tanya.cheba12@gmail.com">tanya.cheba12@gmail.com</a>
      </div>
      <div>
        <img src="/public/telegram.png" alt="" srcset="" width="20px" height="20px" />
        <a href="tg://resolve?domain=tatianacheb">@tatianacheb</a>
      </div>
      <div>
        <img src="/public/github.png" alt="" srcset="" width="20px" height="20px" />
        <a href="https://github.com/tatacheba">tatacheba</a>
      </div>
    </div>
...
#project div,
#project div:hover ul li {
  border-radius: 5px;
}
#project div ul li:hover {
