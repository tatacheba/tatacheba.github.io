...
const router = (0, vue_router_1.createRouter)({
    ...
    routes: [
        ...
        },
        {
            path: '/qaiunokian',
            name: 'QaPageIUNokian',
            component: () => Promise.resolve().then(() => __importStar(require('../views/QaPageIUNokian.vue')))
        },
        {
            path: '/qaapinokian',
            name: 'QaPageAPINokian',
            component: () => Promise.resolve().then(() => __importStar(require('../views/QaPageAPINokian.vue')))
        },
        {
            path: '/qamobilewiki',
            name: 'QaMobileWiki',
            component: () => Promise.resolve().then(() => __importStar(require('../views/QaPageMobileWiki.vue')))
        }
    ]
});
